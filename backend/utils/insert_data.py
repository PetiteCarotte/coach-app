""" Module pour insérer des données par défaut dans la base de données. """
...
def insert_default_programs():
    ...
    if Program.query.count() == 0:
        ...
        programs = [
            ...
            description=(
                'Un programme conçu pour brûler les graisses et affiner '
                'votre corps de manière saine et durable.'
            ),
            duration_minutes='60'
            ),
            Program(
            name='Muscle & Force',
            description=(
                'Un programme intensif pour augmenter votre masse '
                'musculaire et renforcer votre corps.'
            ),
            duration_minutes='60',
            ),
            Program(
            name='Bilan Fitness',
            description=(
                'Une évaluation complète de votre condition physique '
                'pour définir un plan d\'action sur-mesure.'
            ),
            duration_minutes='60',
            )
        ]
